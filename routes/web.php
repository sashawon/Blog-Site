...
Route::get('/', [front\Post::class,'home']);
Route::get('/post/{id}', [front\Post::class,'post']);
Route::get('/page/{id}', [front\Post::class,'page']);
...
route::group(['middleware'=>['admin_auth']],function(){
	...
	Route::view('/admin/page/edit', 'admin.page.edit');
